         ...
         <div class="page d-flex flex-row flex-column-fluid">
                     ...
                     <div class="menu side-menu-custom menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
                        <div class="menu-item">
                           <div class="menu-content pt-8 pb-2">
                               <span class="menu-section text-muted text-uppercase fs-8 ls-1">Module Doctype Set</span>
                           </div>
                        </div>
                        @foreach ($doctype_list_group as $item)  
                           <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                              <span class="menu-link">                               
                                 <span class="menu-title">{{$item->doctype_name}}</span>
                              ...
                              <div class="menu-sub menu-sub-accordion">   
                                 ...
                                 @if($docTypeTenatns)
                                 <div class="menu-item">
                                    <a class="menu-link" href="{{url('admin/doctype/'.$doctype_item->doctype_slug)}}">
                                          <span class="menu-bullet">
                                             <span class="bullet bullet-dot"></span>
                                          </span>
                                          <span class="menu-title">{{$doctype_item->doctype_name}}</span>
                                    </a>
                                 </div>@endif
                                 @endforeach
                              </div>
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
               ...
               <div id="kt_header"  class="header align-items-stretch">
                  <!--begin::Container-->
                  <div style=" width: 300px; align-items: center; padding: 15px 24px;"><a href="{{url('admin')}}">
